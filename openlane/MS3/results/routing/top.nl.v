module top (clk,
 ...
 sky130_fd_sc_hd__and3b_1 _247_ (.A_N(_097_),
    ...
    .C(_099_),
    .X(_100_));
 sky130_fd_sc_hd__buf_2 _248_ (.A(_100_),
    .X(_002_));
 ...
 sky130_fd_sc_hd__o221a_2 _266_ (.A1(_112_),
    ...
    .C1(_065_),
    .X(_117_));
 sky130_fd_sc_hd__mux2_1 _267_ (.A0(net64),
    .A1(\u_am0.i_index[0] ),
    .S(_117_),
    .X(_118_));
 sky130_fd_sc_hd__clkbuf_1 _268_ (.A(_118_),
    .X(_003_));
 sky130_fd_sc_hd__mux2_1 _269_ (.A0(net61),
    .A1(\u_am0.i_index[1] ),
    .S(_117_),
    .X(_119_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _291_ (.A(_135_),
    .X(_009_));
 sky130_fd_sc_hd__mux2_1 _292_ (.A0(net66),
    .A1(net6),
    .S(_134_),
    .X(_136_));
 ...
 sky130_fd_sc_hd__a21o_1 _294_ (.A1(_065_),
    ...
    .B1(net31),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _295_ (.A0(net45),
    .A1(\u_am0.i_index[0] ),
    .S(_126_),
    .X(_137_));
 sky130_fd_sc_hd__clkbuf_1 _296_ (.A(_137_),
    .X(_012_));
 sky130_fd_sc_hd__mux2_1 _297_ (.A0(net37),
    .A1(\u_am0.i_index[1] ),
    .S(_126_),
    .X(_138_));
 sky130_fd_sc_hd__clkbuf_1 _298_ (.A(_138_),
    .X(_013_));
 sky130_fd_sc_hd__mux2_1 _299_ (.A0(net34),
    .A1(\u_am0.i_index[2] ),
    .S(_126_),
    .X(_139_));
 ...
 sky130_fd_sc_hd__o221a_2 _306_ (.A1(_140_),
    ...
    .C1(_065_),
    .X(_145_));
 sky130_fd_sc_hd__mux2_1 _307_ (.A0(net72),
    .A1(net8),
    .S(_145_),
    .X(_146_));
 sky130_fd_sc_hd__clkbuf_1 _308_ (.A(_146_),
    .X(_015_));
 sky130_fd_sc_hd__mux2_1 _309_ (.A0(net70),
    .A1(net9),
    .S(_145_),
    .X(_147_));
 ...
 sky130_fd_sc_hd__a21o_1 _311_ (.A1(_065_),
    ...
    .B1(net27),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _312_ (.A0(net39),
    .A1(\u_am0.i_index[0] ),
    .S(_134_),
    .X(_148_));
 sky130_fd_sc_hd__clkbuf_1 _313_ (.A(_148_),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _314_ (.A0(net48),
    .A1(\u_am0.i_index[1] ),
    .S(_134_),
    .X(_149_));
 sky130_fd_sc_hd__clkbuf_1 _315_ (.A(_149_),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _316_ (.A0(net52),
    .A1(\u_am0.i_index[2] ),
    .S(_134_),
    .X(_150_));
 ...
 sky130_fd_sc_hd__o221a_2 _323_ (.A1(_151_),
    ...
    .C1(_065_),
    .X(_156_));
 sky130_fd_sc_hd__mux2_1 _324_ (.A0(net67),
    .A1(net11),
    .S(_156_),
    .X(_157_));
 sky130_fd_sc_hd__clkbuf_1 _325_ (.A(_157_),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _326_ (.A0(net69),
    .A1(net12),
    .S(_156_),
    .X(_158_));
 ...
 sky130_fd_sc_hd__a21o_1 _328_ (.A1(_065_),
    ...
    .B1(net29),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _329_ (.A0(net50),
    .A1(\u_am0.i_index[0] ),
    .S(_145_),
    .X(_159_));
 sky130_fd_sc_hd__clkbuf_1 _330_ (.A(_159_),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _331_ (.A0(net63),
    .A1(\u_am0.i_index[1] ),
    .S(_145_),
    .X(_160_));
 sky130_fd_sc_hd__clkbuf_1 _332_ (.A(_160_),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _333_ (.A0(net47),
    .A1(\u_am0.i_index[2] ),
    .S(_145_),
    .X(_161_));
 sky130_fd_sc_hd__clkbuf_1 _334_ (.A(_161_),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _335_ (.A0(net71),
    .A1(net14),
    .S(_117_),
    .X(_162_));
 sky130_fd_sc_hd__clkbuf_1 _336_ (.A(_162_),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _337_ (.A0(net68),
    .A1(net15),
    .S(_117_),
    .X(_163_));
 ...
 sky130_fd_sc_hd__a21o_1 _339_ (.A1(net16),
    ...
    .B1(net30),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _340_ (.A0(net60),
    .A1(\u_am0.i_index[0] ),
    .S(_156_),
    .X(_164_));
 sky130_fd_sc_hd__clkbuf_1 _341_ (.A(_164_),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _342_ (.A0(net36),
    .A1(\u_am0.i_index[1] ),
    .S(_156_),
    .X(_165_));
 sky130_fd_sc_hd__clkbuf_1 _343_ (.A(_165_),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _344_ (.A0(net58),
    .A1(\u_am0.i_index[2] ),
    .S(_156_),
    .X(_166_));
 ...
 sky130_fd_sc_hd__mux2_1 _348_ (.A0(\u_sort.bucket_reg[4][1] ),
    ...
    .S(_098_),
    .X(_168_));
 sky130_fd_sc_hd__clkbuf_1 _349_ (.A(net62),
    .X(_034_));
 sky130_fd_sc_hd__mux2_1 _350_ (.A0(\u_sort.bucket_reg[4][2] ),
    .A1(net56),
    .S(_098_),
    .X(_169_));
 sky130_fd_sc_hd__clkbuf_1 _351_ (.A(net57),
    .X(_035_));
 ...
 sky130_fd_sc_hd__mux2_1 _356_ (.A0(\u_sort.bucket_reg[3][2] ),
    ...
    .S(_098_),
    .X(_172_));
 sky130_fd_sc_hd__clkbuf_1 _357_ (.A(net59),
    .X(_038_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _361_ (.A(_174_),
    .X(_040_));
 sky130_fd_sc_hd__mux2_1 _362_ (.A0(net51),
    .A1(net47),
    .S(_098_),
    .X(_175_));
 ...
 sky130_fd_sc_hd__mux2_1 _368_ (.A0(\u_sort.bucket_reg[1][2] ),
    ...
    .S(_098_),
    .X(_178_));
 sky130_fd_sc_hd__clkbuf_1 _369_ (.A(net53),
    .X(_044_));
 sky130_fd_sc_hd__mux2_1 _370_ (.A0(\u_sort.bucket_reg[0][0] ),
    .A1(net45),
    .S(_098_),
    .X(_179_));
 sky130_fd_sc_hd__clkbuf_1 _371_ (.A(net46),
    .X(_045_));
 sky130_fd_sc_hd__mux2_1 _372_ (.A0(\u_sort.bucket_reg[0][1] ),
    .A1(net37),
    .S(_098_),
    .X(_180_));
 sky130_fd_sc_hd__clkbuf_1 _373_ (.A(net38),
    .X(_046_));
 sky130_fd_sc_hd__mux2_1 _374_ (.A0(\u_sort.bucket_reg[0][2] ),
    .A1(net34),
    .S(_098_),
    .X(_181_));
 sky130_fd_sc_hd__clkbuf_1 _375_ (.A(net35),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _376_ (.A0(net42),
    .A1(\u_sort.bucket_counter[0] ),
    .S(_002_),
    .X(_182_));
 sky130_fd_sc_hd__clkbuf_1 _377_ (.A(_182_),
    .X(_048_));
 sky130_fd_sc_hd__mux2_1 _378_ (.A0(net40),
    .A1(_071_),
    .S(_002_),
    .X(_183_));
 sky130_fd_sc_hd__clkbuf_1 _379_ (.A(_183_),
    .X(_049_));
 sky130_fd_sc_hd__mux2_1 _380_ (.A0(net44),
    .A1(_074_),
    .S(_002_),
    .X(_184_));
 ...
 sky130_fd_sc_hd__o21ai_1 _383_ (.A1(_087_),
    ...
    .B1(_107_),
    .Y(_186_));
 sky130_fd_sc_hd__mux2_1 _384_ (.A0(net65),
    .A1(_186_),
    .S(_002_),
    .X(_187_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _388_ (.A(_189_),
    .X(_052_));
 sky130_fd_sc_hd__mux2_1 _389_ (.A0(net41),
    .A1(_102_),
    .S(_002_),
    .X(_190_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _427_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .RESET_B(net17),
    .Q(\u_am0.max[1] ));
 sky130_fd_sc_hd__dfrtp_1 _428_ (.CLK(clknet_3_0__leaf_clk),
    .D(_008_),
    .RESET_B(net17),
    .Q(\u_am0.max[2] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _436_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(net17),
    .Q(\u_am2.max[1] ));
 sky130_fd_sc_hd__dfrtp_1 _437_ (.CLK(clknet_3_2__leaf_clk),
    .D(_017_),
    .RESET_B(net17),
    .Q(\u_am2.max[2] ));
 sky130_fd_sc_hd__dfrtp_1 _438_ (.CLK(clknet_3_1__leaf_clk),
    .D(_018_),
    .RESET_B(net17),
    .Q(\u_am1.b_i[0] ));
 sky130_fd_sc_hd__dfrtp_1 _439_ (.CLK(clknet_3_0__leaf_clk),
    .D(_019_),
    .RESET_B(net17),
    .Q(\u_am1.b_i[1] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _441_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(net17),
    .Q(\u_am3.max[0] ));
 sky130_fd_sc_hd__dfrtp_1 _442_ (.CLK(clknet_3_2__leaf_clk),
    .D(_022_),
    .RESET_B(net17),
    .Q(\u_am3.max[1] ));
 sky130_fd_sc_hd__dfrtp_1 _443_ (.CLK(clknet_3_2__leaf_clk),
    .D(_023_),
    .RESET_B(net17),
    .Q(\u_am3.max[2] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _451_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .RESET_B(net17),
    .Q(\u_am3.b_i[1] ));
 sky130_fd_sc_hd__dfrtp_1 _452_ (.CLK(clknet_3_3__leaf_clk),
    .D(_032_),
    .RESET_B(net17),
    .Q(\u_am3.b_i[2] ));
 sky130_fd_sc_hd__dfrtp_1 _453_ (.CLK(clknet_3_6__leaf_clk),
    .D(_033_),
    .RESET_B(net17),
 ...
 sky130_fd_sc_hd__dfrtp_1 _456_ (.CLK(clknet_3_6__leaf_clk),
    .D(_036_),
    .RESET_B(net17),
 ...
 sky130_fd_sc_hd__dfrtp_1 _463_ (.CLK(clknet_3_1__leaf_clk),
    .D(_043_),
    .RESET_B(net17),
 ...
 sky130_fd_sc_hd__dfrtp_1 _466_ (.CLK(clknet_3_4__leaf_clk),
    .D(_046_),
    .RESET_B(net17),
    .Q(\u_sort.bucket_reg[0][1] ));
 sky130_fd_sc_hd__dfrtp_1 _467_ (.CLK(clknet_3_4__leaf_clk),
    .D(_047_),
    .RESET_B(net17),
 ...
 sky130_fd_sc_hd__dfrtp_1 _472_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .RESET_B(net17),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _473_ (.CLK(clknet_3_5__leaf_clk),
    .D(_052_),
    .RESET_B(net17),
    .Q(net22));
 sky130_fd_sc_hd__dfrtp_1 _474_ (.CLK(clknet_3_5__leaf_clk),
    .D(_053_),
    .RESET_B(net17),
    .Q(net23));
 ...
 sky130_fd_sc_hd__dfrtp_4 _484_ (.CLK(clknet_3_0__leaf_clk),
    .D(_062_),
    .RESET_B(net17),
    .Q(\u_am0.i_index[0] ));
 sky130_fd_sc_hd__dfrtp_4 _485_ (.CLK(clknet_3_0__leaf_clk),
    .D(_063_),
    .RESET_B(net17),
    .Q(\u_am0.i_index[1] ));
 sky130_fd_sc_hd__dfrtp_4 _486_ (.CLK(clknet_3_0__leaf_clk),
    .D(_064_),
    .RESET_B(net17),
    .Q(\u_am0.i_index[2] ));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\u_am2.max[2] ),
    .X(net27));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\u_am0.max[2] ),
    .X(net28));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\u_am3.max[2] ),
    .X(net29));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\u_am4.max[2] ),
    .X(net30));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(\u_am1.max[2] ),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(\u_sort.valid_reg[0] ),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(\u_sort.valid_reg[1] ),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold8 (.A(\u_am0.b_i[2] ),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold9 (.A(_181_),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold10 (.A(\u_am3.b_i[1] ),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold11 (.A(\u_am0.b_i[1] ),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold12 (.A(_180_),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold13 (.A(\u_am1.b_i[0] ),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold14 (.A(net19),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold15 (.A(net23),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(net18),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\u_am0.i_index[2] ),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(net20),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(\u_am0.b_i[0] ),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(_179_),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(\u_am2.b_i[2] ),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(\u_am1.b_i[1] ),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold23 (.A(\u_am0.i_index[1] ),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold24 (.A(\u_am2.b_i[0] ),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold25 (.A(\u_sort.bucket_reg[2][2] ),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold26 (.A(\u_am1.b_i[2] ),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold27 (.A(_178_),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold28 (.A(net22),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold29 (.A(\u_am0.i_index[0] ),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold30 (.A(\u_am4.b_i[2] ),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold31 (.A(_169_),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\u_am3.b_i[2] ),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(_172_),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\u_am3.b_i[0] ),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\u_am4.b_i[1] ),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(_168_),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\u_am2.b_i[1] ),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\u_am4.b_i[0] ),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(net21),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\u_am1.max[1] ),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\u_am3.max[0] ),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\u_am4.max[1] ),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\u_am3.max[1] ),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\u_am2.max[1] ),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\u_am4.max[0] ),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\u_am2.max[0] ),
    .X(net72));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_4_58 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_5_10 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_7_10 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_9_85 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_11_95 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_14_130 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_16_151 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_17_184 ();
 sky130_fd_sc_hd__fill_2 FILLER_0_18_23 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_18_38 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_18_44 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_18_145 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_20_39 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_21_62 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_21_139 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_23_133 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_24_144 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_25_77 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_27_10 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_32_9 ();
